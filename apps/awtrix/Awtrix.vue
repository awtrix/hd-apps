<template>
  <div>
    This is the Awtrix app scaffolding. This is not supposed to be used as is.
    Please refer to the <a href="#" target="_blank">Developer Documentation</a>
    to find out how to correctly utilize this.
  </div>
</template>
