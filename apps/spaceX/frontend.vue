...
<div id='subtitle'>
  <span>
    {{ data.launch_date_local }}
        ...
        <img class="m-10 center" src="./imgs/logo.png" />
      </div>
    ...
    getData() {
      fetch("https://api.spacexdata.com/v3/launches/next", {})
        ...
        .then((data) => {
          this.data = data;
          console.log(data);
          data.launch_date_unix = data.launch_date_unix * 1000;
...
@import '/usr/local/lib/node_modules/compass-mixins/lib/_compass.scss'
...
#earth
  ...
  &:after
    ...
    @include background-image(linear-gradient(left, rgba(0,0,0,1) 0%,rgba(0,0,0,0) 50%,rgba(0,0,0,1) 100%))
    content: " "
    position: absolute
    width: 100%
    height: 100%
